...
RLSATNServicesEncoding::RLSATNServicesEncoding(RLSAT * instance) : instance(instance){

}

SMTFormula *  RLSATNServicesEncoding::encode(int lb, int ub) {
...
void RLSATNServicesEncoding::checkSolution(const string & filename){
...
int RLSATNServicesEncoding::checkAllSoftClauses(){
    int cost = 0;
