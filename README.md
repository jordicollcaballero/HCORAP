...
```
which generates an encoding using the MaxSAT version of DIMACS standard, [version post-2022 edition of the MaxSAT evaluation](@https://maxsat-evaluations.github.io/2022/rules.html#input).
